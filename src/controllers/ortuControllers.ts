...
export const create = async (req: Request, res: Response) => {
  try {
    ...
    res.status(201).json({ message: 'Orang Tua created', status: 201, data: result });
  } catch (err: any) {
...
export const getOne = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ message: 'Orang Tua found', status: 200, data });
  } catch (err: any) {
    res.status(500).json({ message: 'Internal server error', status: 500 });
  }
};
...
export const update = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const oldEmail = ortuLama.user?.email;
    ...
    res.status(200).json({ message: "Orang Tua updated", status: 200, data: result });
  } catch (err: any) {
...
export const remove = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ message: 'Orang Tua deleted', status: 200, data: result });
  } catch (err: any) {
    if (err.message.includes('Orang Tua not found')) {
      return res.status(404).json({ message: 'Orang Tua not found', status: 404 });
    }
