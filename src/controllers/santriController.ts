...
export const create = async (req: Request, res: Response) => {
  try {
    ...
    res.status(201).json({ message: 'Santri created', status: 201, data: result });
  } catch (err: any) {
...
export const getOne = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ message: 'Santri found', status: 200, data });
  } catch (err: any) {
    res.status(500).json({ message: 'Internal server error', status: 500 });
  }
};
...
export const update = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const oldEmail = santriLama.user?.email;
    const newEmail = validation.data.email;
    ...
    res.status(200).json({ message: 'Santri updated', status: 200, data: result });
  } catch (err: any) {
...
export const remove = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ message: 'Santri deleted', status: 200, data: result });
  } catch (err: any) {
...
export const getAll = async (req: AuthRequest, res: Response) => {
  try {
    ...
    res.status(200).json({ message: 'Santri found', status: 200, ...result });
  } catch (error: any) {
    res.status(500).json({ message: 'Internal Server Error', status: 500 });
  }
};
...
export const resetAllPoints = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ message: 'All santri points have been reset.', status: 200 });
  } catch (error: any) {
...
export const deductPoints = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ message: 'Points successfully deducted.', status: 200, data: updatedSantri });
  } catch (error: any) {
