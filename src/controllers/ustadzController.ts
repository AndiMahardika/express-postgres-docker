...
export const create = async (req: Request, res: Response) => {
  try {
    ...
    res.status(201).json({ message: 'Ustadz created', status: 201, data: result });
  } catch (err: any) {
...
export const getOne = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ message: 'Ustadz found', status: 200, data });
  } catch (err: any) {
    res.status(500).json({ message: 'Internal server error', status: 500 });
  }
};
...
export const update = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const oldEmail = ustadzLama.user?.email;
    ...
    res.status(200).json({ message: 'Ustadz updated', status: 200, data: result });
  } catch (err: any) {
...
export const remove = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ message: 'Ustadz deleted', status: 200, data: result });
  } catch (err: any) {
