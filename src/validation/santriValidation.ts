...
// const checkNoIndukUniqueRegister = z.string().min(1, "Nomor Induk must be at least 1 characters long")
//   .refine(async (noInduk) => {
//     const existingSantri = await prisma.santri.findUnique({ where: { noInduk } });
//     return !existingSantri;
//   }, {
//   message: "Nomor Induk already exists.",
// });

// const checkNoIndukUniqueUpdate = z.string().min(1, "Nomor Induk must be at least 1 characters long")
//   .optional()
//   .refine(async (noInduk) => {
//     if (!noInduk) return true;
//     return true;
//   }, {
//     message: "Nomor Induk already exists.",
// });
...
export const UpdateSantriSchema = z.object({
  ...
  nomorHp: z.string().optional(),
  // noInduk: checkNoIndukUniqueUpdate,
  noInduk: z.string().min(1, "Nomor Induk must be at least 1 characters long").optional(),
